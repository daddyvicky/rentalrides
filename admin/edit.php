...
if(isset($_GET['id'])){
    ...
    if(isset($_POST['submit'])){
        $qq = "SELECT * FROM vehicles WHERE vid='$_POST[vid]'";
        $ee = Query($qq);
        ...
        if(empty($errors)==true) {
            ...
            $sql = "UPDATE vehicles SET date = '$dateTime', vname = '$vname', vrate = '$vrate',image = '$basename', vdisc = '$vdisc', status='$vstatus',states='$_POST[stt]',city='$_POST[city]' WHERE vid = '$vid'";
            $exec = Query($sql);
            if($exec){
                $check=1;
            }
    ...
    <main class="ps-main">
        ...
        <div class="ps-main__wrapper">
            ...
            <section class="ps-new-item">
                <form class="ps-form ps-form--new-product" action="edit.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                <figure class="ps-block--form-box">
                                    ...
                                    <div class="ps-block__content">
                                        ...
                                        <input type="number" value="<?php echo $_GET['id']?>" name="vid" hidden/>
                                        <div class="form-group">
                                            <label>Name of Vehicle<sup>*</sup>
                                            </label>
                                            <input class="form-control" type="text" placeholder="Enter product name..." name="vname" value="<?php echo $vehicle['vname']?>" required/>
                                        </div>
                                        <div class="form-group">
                                            <label>Status<sup>*</sup>
                                            </label>
                                                <select class="ps-select" title="Type" name="status" required>
                                                    <option value="car">Free</option>
                                                    <option value="bike">Occupied</option>
                                                </select>
                                        </div>
                                        <div class="form-group">
                                            <label>Price per day<sup>*</sup>
                                            </label>
                                            <input class="form-control" type="number" placeholder="Enter Price per day" value="<?php echo $vehicle['vrate']?>" name="vrate" required/>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" rows="6" placeholder="Enter Vehicle description..." name="vdisc" required minlength="80"><?php echo $vehicle['vdisc']?></textarea>
                                        </div>
                                    </div>
                                </figure>
                            </div>
